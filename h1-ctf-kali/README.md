...
![arp-scan-utun-1](/assignments/h1-ctf-kali/screenshots/arp-scan-utun-1.png)
...
![arp-scan-utun-2](/assignments/h1-ctf-kali/screenshots/arp-scan-utun-2.png)

Laitoin myös laitteen pois päältä komennolla `sudo ifconfig utun0 down`.

Uusi yritys:\
![arp-scan](/assignments/h1-ctf-kali/screenshots/arp-scan.png)
...
![nc-1](/assignments/h1-ctf-kali/screenshots/nc-1.png)

Entäs portti `53`, jolla kuuntelee `dnscrypt-proxy`:\
![nc-2](/assignments/h1-ctf-kali/screenshots/nc-2.png)

Entäs RDP-palvelin:\
![nc-3](/assignments/h1-ctf-kali/screenshots/nc-3.png)

Viimeiseksi kokeilin `nmap`ia optioilla `-sSU` (tcp+udp) ja `-p-` (portit 1-65535).\
...
![nmap](/assignments/h1-ctf-kali/screenshots/nmap.png)
...
Alkuun laitoin Kalin tikulle `dd`llä (HUOM: Jos käytät GNU:n `dd`-ohjelmaa, täytyy `bs`-optiossa käyttää isoa kirjainta, eli `bs=1M`):\
![dd-kali](/assignments/h1-ctf-kali/screenshots/dd-kali.png)
